...
## v2.0.0-beta.5 (by [hiimjasmine00](https://geode-sdk.org/developers/37))
- Fix crashes when trying to login with argon ([pull #57](https://github.com/lil2kki/Geode-Mod-Comments/pull/57))
